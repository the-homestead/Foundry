...
import { Link } from "@foundry/iam/i18n/navigation";
...
function NavigationItem({ tab, active, onClick, twoFactorEnabled }: { tab: AccountTab; active: boolean; onClick?: () => void; twoFactorEnabled: boolean }) {
    ...
    // Use next-intl's Link (created via createNavigation) so links include
    // locale-prefixing correctly and remain declarative.
    return (
        <Link
    ...
    return (
        <>
            ...
            <div className="hidden lg:flex lg:gap-8">
                <aside className="sticky top-8 h-fit w-70 shrink-0">
