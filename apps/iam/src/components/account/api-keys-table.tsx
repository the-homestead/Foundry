...
export function ApiKeysTable({
    ...
    // hide noisy/less-useful columns by default (users can enable them from the Columns menu)
    const [columnVisibility, setColumnVisibility] = useState<VisibilityState>({ prefix: false, tags: false });
