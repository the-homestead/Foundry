...
import { getLinkedAccounts, revalidateLinkedAccountsTag } from "@foundry/iam/actions/accounts";
    ...
    const handleUnlinkAccount = useCallback(
        async (providerId: string) => {
            try {
                ...
                // Invalidate server-side cache for linked accounts (if any)
                // so future server renders / Cache Components see the update.
                try {
                    await revalidateLinkedAccountsTag();
                } catch (err) {
    ...
    return (
        ...
        >
            <div className="grid gap-6 lg:grid-cols-12">
                {/* Make identity + avatar a single, cohesive card to improve discoverability */}
                <div className="flex flex-col gap-6 lg:col-span-12">
                                                                ...
                                                                <div className="flex cursor-pointer items-center gap-2 text-muted-foreground text-xs">
                                                                    <Checkbox
                                                                        ...
                                                                        onCheckedChange={(checked) => {
                                                                            ...
                                                                            // autosave immediately when visibility toggles
                                                                            form.handleSubmit();
                                                                        }}
                                                                    />
                                                                    <span>Public</span>
                    ...
                    {/* Connected accounts moved under identity so related actions are grouped together */}
                    <Card>
                        <CardHeader>
