            ...
            return (
                <div
                    className={cn(
                        ...
                        key.startsWith("latte") && "bg-linear-to-br from-blue-200 to-blue-400",
                        key.startsWith("mocha") && "bg-linear-to-br from-gray-800 to-gray-600",
                        key.startsWith("frappe") && "bg-linear-to-br from-slate-700 to-slate-500",
                        key.startsWith("macchiato") && "bg-linear-to-br from-indigo-800 to-indigo-600"
                    )}
                />
            );
    }
...
export function ThemeSheet({ triggerClassName }: { triggerClassName?: string }) {
    ...
    return (
        <Sheet>
            ...
            <SheetContent className="w-120 overflow-y-auto" side="right">
                                    ...
                                    {["latte", "mocha", "frappe", "macchiato"].map((key) => (
                                        ...
                                        >
                                            <div className="flex w-full items-center gap-3">
                                                ...
                                                {theme === key && <Check className="h-4 w-4 shrink-0" />}
                                            </div>
                                        </Button>
                                    ))}
                                </div>
