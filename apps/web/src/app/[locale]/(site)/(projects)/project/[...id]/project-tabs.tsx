        ...
        <Tabs className="space-y-4" onValueChange={setValue} value={value}>
            ...
            <TabsContent value="files">
                {(() => {
                    ...
                    return <ProjectFilesTab canEdit={canEdit} mainDownload={mainDownload ?? ({} as ProjectFile)} optionalDownloads={optionalDownloads} projectSlug={projectSlug} />;
                })()}
            </TabsContent>
            <TabsContent value="gallery">
                <ProjectGalleryTab canEdit={canEdit} gallery={gallery} projectSlug={projectSlug} />
            </TabsContent>
