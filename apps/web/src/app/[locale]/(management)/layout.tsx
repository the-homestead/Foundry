...
import { callAuthApi, getServerSession } from "@foundry/web/lib/get-server-session";
...
export default async function AdminLayout({ children, params }: { children: React.ReactNode; params: Promise<{ locale: string }> }) {
    ...
    async function permissionCheck({ userId }: { userId: string }) {
        ...
        const permCheck = (await callAuthApi("/api/auth/user-has-permission", {
            method: "POST",
            body: {
                userId,
                role: "admin",
        ...
        return Boolean(permCheck.granted);
    }
