...
export const OrgDeleted = async ({ name, locale, orgName }: OrgDeletedProps) => {
    ...
    const previewText = t("organization.deleted.preview", { orgName: orgName ?? "" });
                ...
                <Body className="mx-auto my-auto px-2 font-sans" style={{ backgroundColor: EMAIL_COLORS.background }}>
                    ...
                    >
                        <Heading className="mx-0 mb-[8px] text-center font-semibold text-[22px]" style={{ color: EMAIL_COLORS.foreground }}>
                            {t("organization.deleted.subject", { orgName: orgName ?? "" })}
                        </Heading>
                        ...
                        <Text className="mb-[12px] text-center text-[14px]" style={{ color: EMAIL_COLORS.foreground }}>
                            {t("organization.deleted.body", { orgName: orgName ?? "" })}
                        </Text>
...
OrgDeleted.PreviewProps = { name: "Jane", orgName: "Foundry Labs", locale: "en" } as OrgDeletedProps;

export default OrgDeleted;
