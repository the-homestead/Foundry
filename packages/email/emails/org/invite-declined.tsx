...
export const InviteDeclined = async ({ name, locale, orgName, inviter }: InviteDeclinedProps) => {
    ...
    const previewText = t("organization.inviteDeclined.preview", { orgName: orgName ?? "" });
                ...
                <Body className="mx-auto my-auto px-2 font-sans" style={{ backgroundColor: EMAIL_COLORS.background }}>
                    ...
                    >
                        <Heading className="mx-0 mb-[8px] text-center font-semibold text-[22px]" style={{ color: EMAIL_COLORS.foreground }}>
                            {t("organization.inviteDeclined.subject", { orgName: orgName ?? "" })}
                        </Heading>
                        ...
                        <Text className="mb-[12px] text-center text-[14px]" style={{ color: EMAIL_COLORS.foreground }}>
                            {t("organization.inviteDeclined.body", { inviter: inviter ?? "", orgName: orgName ?? "" })}
                        </Text>
...
InviteDeclined.PreviewProps = { name: "Alice", orgName: "Foundry Labs", inviter: "Bob", locale: "en" } as InviteDeclinedProps;
