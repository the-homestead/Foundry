...
export const TeamMemberRemoved = async ({ name, locale, teamName, orgName, details }: TeamMemberRemovedProps) => {
    ...
    const previewText = t("organization.teamMemberRemoved.preview", { teamName: teamName ?? "" });
                ...
                <Body className="mx-auto my-auto px-2 font-sans" style={{ backgroundColor: EMAIL_COLORS.background }}>
                    ...
                    >
                        <Heading className="mx-0 mb-[8px] text-center font-semibold text-[22px]" style={{ color: EMAIL_COLORS.foreground }}>
                            {t("organization.teamMemberRemoved.subject", { teamName: teamName ?? "" })}
                        </Heading>
                        ...
                        <Text className="mb-[12px] text-center text-[14px]" style={{ color: EMAIL_COLORS.foreground }}>
                            {t("organization.teamMemberRemoved.body", { details: details ?? "" })}
                        </Text>
...
TeamMemberRemoved.PreviewProps = { name: "Jane", teamName: "Engineering", orgName: "Foundry Labs", details: "Removed due to inactivity", locale: "en" } as TeamMemberRemovedProps;
