...
export const TeamCreated = async ({ name, locale, teamName, orgName, manageUrl }: TeamCreatedProps) => {
    ...
    const previewText = t("organization.team.created.preview", { teamName: teamName ?? "" });
                ...
                <Body className="mx-auto my-auto px-2 font-sans" style={{ backgroundColor: EMAIL_COLORS.background }}>
                    ...
                    >
                        <Heading className="mx-0 mb-[8px] text-center font-semibold text-[22px]" style={{ color: EMAIL_COLORS.foreground }}>
                            {t("organization.team.created.subject", { teamName: teamName ?? "" })}
                        </Heading>
                        ...
                        <Text className="mb-[12px] text-center text-[14px]" style={{ color: EMAIL_COLORS.foreground }}>
                            {t("organization.team.created.body", { teamName: teamName ?? "", orgName: orgName ?? "" })}
                        </Text>
...
TeamCreated.PreviewProps = {
    name: "Jane",
    teamName: "Engineering",
    orgName: "Foundry Labs",
    manageUrl: "https://example.com/orgs/org-123/teams",
    locale: "en",
} as TeamCreatedProps;
