...
export const InviteAccepted = async ({ name, locale, orgName, inviter }: InviteAcceptedProps) => {
    ...
    const previewText = t("organization.inviteAccepted.preview", { orgName: orgName ?? "" });
                ...
                <Body className="mx-auto my-auto px-2 font-sans" style={{ backgroundColor: EMAIL_COLORS.background }}>
                    ...
                    >
                        <Heading className="mx-0 mb-[8px] text-center font-semibold text-[22px]" style={{ color: EMAIL_COLORS.foreground }}>
                            {t("organization.inviteAccepted.subject", { orgName: orgName ?? "" })}
                        </Heading>
                        ...
                        <Text className="mb-[12px] text-center text-[14px]" style={{ color: EMAIL_COLORS.foreground }}>
                            {t("organization.inviteAccepted.body", { inviter: inviter ?? "", orgName: orgName ?? "" })}
                        </Text>
...
InviteAccepted.PreviewProps = { name: "Jane", orgName: "Foundry Labs", inviter: "Alice", locale: "en" } as InviteAcceptedProps;
