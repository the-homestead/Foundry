...
export const OrgUpdated = async ({ name, locale, orgName, details }: OrgUpdatedProps) => {
    ...
    const previewText = t("organization.updated.preview", { orgName: orgName ?? "" });
                ...
                <Body className="mx-auto my-auto px-2 font-sans" style={{ backgroundColor: EMAIL_COLORS.background }}>
                    ...
                    >
                        <Heading className="mx-0 mb-[8px] text-center font-semibold text-[22px]" style={{ color: EMAIL_COLORS.foreground }}>
                            {t("organization.updated.subject", { orgName: orgName ?? "" })}
                        </Heading>
                        ...
                        <Text className="mb-[12px] text-center text-[14px]" style={{ color: EMAIL_COLORS.foreground }}>
                            {t("organization.updated.body", { details: details ?? "" })}
                        </Text>
...
OrgUpdated.PreviewProps = { name: "Jane", orgName: "Foundry Labs", details: "New logo and description", locale: "en" } as OrgUpdatedProps;

export default OrgUpdated;
