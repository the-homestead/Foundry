...
export const OrgCreated = async ({ name, locale, orgName, manageUrl }: OrgCreatedProps) => {
    ...
    const previewText = t("organization.created.preview", { orgName: orgName ?? "" });
                ...
                <Body className="mx-auto my-auto px-2 font-sans" style={{ backgroundColor: EMAIL_COLORS.background }}>
                    ...
                    >
                        <Heading className="mx-0 mb-[8px] text-center font-semibold text-[22px]" style={{ color: EMAIL_COLORS.foreground }}>
                            {t("organization.created.subject", { orgName: orgName ?? "" })}
                        </Heading>
                        ...
                        <Text className="mb-[12px] text-center text-[14px]" style={{ color: EMAIL_COLORS.foreground }}>
                            {t("organization.created.body", { orgName: orgName ?? "" })}
                        </Text>
...
OrgCreated.PreviewProps = { name: "Jane", orgName: "Foundry Labs", manageUrl: "https://example.com/orgs/org-123", locale: "en" } as OrgCreatedProps;
