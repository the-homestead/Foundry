...
export const AccountDeleted = async ({ name, locale, date }: AccountDeletedProps) => {
    ...
    const previewText = t("accountDeleted.preview");
                ...
                <Body className="mx-auto my-auto px-2 font-sans" style={{ backgroundColor: EMAIL_COLORS.background }}>
                    ...
                    >
                        ...
                        <Text className="mb-[12px] text-center text-[14px]" style={{ color: EMAIL_COLORS.foreground }}>
                            {t("accountDeleted.body", { date: date ?? "—" })}
                        </Text>
...
AccountDeleted.PreviewProps = { name: "Jane", date: "Feb 14, 2026", locale: "en" } as AccountDeletedProps;
