...
export const TwoFactorDisabled = async ({ name, locale }: TwoFactorDisabledProps) => {
    ...
    const previewText = t("twoFactorDisabled.preview");
...
TwoFactorDisabled.PreviewProps = { name: "Jane", locale: "en" } as TwoFactorDisabledProps;
