...
export const TwoFactorEnabled = async ({ name, locale, manageUrl }: TwoFactorEnabledProps) => {
    ...
    const previewText = t("twoFactorEnabled.preview");
...
TwoFactorEnabled.PreviewProps = { name: "Jane", manageUrl: "https://example.com/account?tab=security", locale: "en" } as TwoFactorEnabledProps;
