...
export const EmailChangeNotice = async ({ name, locale, oldEmail, newEmail, manageUrl }: EmailChangeNoticeProps) => {
    ...
    const previewText = t("emailChange.preview");
                ...
                <Body className="mx-auto my-auto px-2 font-sans" style={{ backgroundColor: EMAIL_COLORS.background }}>
                    ...
                    >
                        ...
                        <Text className="mb-[12px] text-center text-[14px]" style={{ color: EMAIL_COLORS.foreground }}>
                            {t("emailChange.body", { oldEmail: oldEmail ?? "—", newEmail: newEmail ?? "—" })}
                        </Text>
...
EmailChangeNotice.PreviewProps = {
    ...
    manageUrl: "https://example.com/account?tab=profile",
    locale: "en",
} as EmailChangeNoticeProps;
