...
export const TreeProvider = ({
    ...
    return (
        ...
        >
            <motion.div animate={{ opacity: 1, y: 0 }} className={cn("w-full", className)} initial={{ opacity: 0, y: 10 }} transition={{ duration: 0.3, ease: "easeOut" }}>
                {children}
            </motion.div>
        </TreeContext.Provider>
    );
...
export const TreeIcon = ({ icon, hasChildren = false, className, ...props }: TreeIconProps) => {
    ...
    // biome-ignore lint/style/noNestedTernary: <Def>
