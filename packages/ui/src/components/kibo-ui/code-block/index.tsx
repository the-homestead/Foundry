...
const lineFocusedClassNames = cn("[&_code:has(.focused)_.line]:blur-[2px]", "[&_code:has(.focused)_.line.focused]:blur-none");
...
export const CodeBlock = ({ value: controlledValue, onValueChange: controlledOnValueChange, defaultValue, className, data, ...props }: CodeBlockProps) => {
...
export const CodeBlockSelectItem = ({ className, ...props }: CodeBlockSelectItemProps) => <SelectItem className={cn("text-sm", className)} {...props} />;
...
const CodeBlockFallback = ({ children, ...props }: CodeBlockFallbackProps) => {
    ...
    const linesWithKeys = lines.map((line) => {
...
export const CodeBlockContent = ({ children, themes, language, syntaxHighlighting = true, ...props }: CodeBlockContentProps) => {
