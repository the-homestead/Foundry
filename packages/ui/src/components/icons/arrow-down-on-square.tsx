...
const ArrowDownOnSquareIcon = forwardRef<ArrowDownOnSquareIconHandle, ArrowDownOnSquareIconProps>(({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    return (
        <div className={cn(className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props}>
            ...
            >
                ...
                <motion.path animate={controls} d="M9 12l3 3m0 0 3-3m-3 3V2.25" variants={ARROW_VARIANTS} />
            </svg>
        </div>
    );
});
