...
const ArrowTurnDownRightIcon = forwardRef<ArrowTurnDownRightIconHandle, ArrowTurnDownRightIconProps>(({ onMouseEnter, onMouseLeave, className, size = 20, ...props }, ref) => {
