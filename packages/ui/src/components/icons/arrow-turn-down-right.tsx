...
interface ArrowTurnDownRightIconProps extends HTMLAttributes<HTMLDivElement> {
    size?: number;
}
...
const ArrowTurnDownRightIcon = forwardRef<ArrowTurnDownRightIconHandle, ArrowTurnDownRightIconProps>(({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
