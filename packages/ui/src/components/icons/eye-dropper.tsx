...
interface EyeDropperIconProps extends HTMLAttributes<HTMLDivElement> {
    size?: number;
}
...
const EyeDropperIcon = forwardRef<EyeDropperIconHandle, EyeDropperIconProps>(({ onMouseEnter, onMouseLeave, className, size = 20, ...props }, ref) => {
