...
interface MagnifyingGlassMinusIconProps extends HTMLAttributes<HTMLDivElement> {
    size?: number;
}
...
const MagnifyingGlassMinusIcon = forwardRef<MagnifyingGlassMinusIconHandle, MagnifyingGlassMinusIconProps>(
        ...
        return (
            <div className={cn(className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props}>
                ...
                >
                    ...
                    <motion.path animate={controls} d="M13.5 10.5H7.5" initial="normal" variants={SYMBOL_VARIANT} />
                </svg>
            </div>
        );
    }
