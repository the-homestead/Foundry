...
interface ArrowUpOnSquareStackIconProps extends HTMLAttributes<HTMLDivElement> {
    size?: number;
}
...
const ArrowUpOnSquareStackIcon = forwardRef<ArrowUpOnSquareStackIconHandle, ArrowUpOnSquareStackIconProps>(
        ...
        return (
            <div className={cn(className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props}>
                ...
                >
                    ...
                    <motion.path animate={controls} d="M13.5 4.5L10.5 1.5M10.5 1.5L7.5 4.5M10.5 1.5L10.5 12.75" initial="normal" variants={ARROW_VARIANTS} />
