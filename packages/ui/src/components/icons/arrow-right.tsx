...
const ArrowRightIcon = forwardRef<ArrowRightIconHandle, ArrowRightIconProps>(({ onMouseEnter, onMouseLeave, className, size = 20, ...props }, ref) => {
    ...
    return (
        <div className={cn(className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props}>
            ...
            >
                <motion.path animate={controls} d="M13.5 4.5 21 12m0 0-7.5 7.5" variants={ARROW_HEAD_VARIANTS} />
