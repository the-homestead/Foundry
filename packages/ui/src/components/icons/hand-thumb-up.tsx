...
interface HandThumbUpIconProps extends HTMLAttributes<HTMLDivElement> {
    size?: number;
}
...
const HandThumbUpIcon = forwardRef<HandThumbUpIconHandle, HandThumbUpIconProps>(({ onMouseEnter, onMouseLeave, className, size = 20, ...props }, ref) => {
