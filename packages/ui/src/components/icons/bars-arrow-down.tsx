...
interface BarsArrowDownIconProps extends HTMLAttributes<HTMLDivElement> {
    size?: number;
}
    ...
    return (
        <div className={cn(className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props}>
            ...
            >
                ...
                <motion.path animate={controls} d="M17.25 9v12m0 0-3.75-3.75M17.25 21L21 17.25" initial="normal" variants={ARROW_VARIANTS} />
            </svg>
        </div>
    );
});
