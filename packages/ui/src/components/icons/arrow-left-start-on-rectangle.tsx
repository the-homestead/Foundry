...
interface ArrowLeftStartOnRectangleIconProps extends HTMLAttributes<HTMLDivElement> {
    size?: number;
}
...
const ArrowLeftStartOnRectangleIcon = forwardRef<ArrowLeftStartOnRectangleIconHandle, ArrowLeftStartOnRectangleIconProps>(
