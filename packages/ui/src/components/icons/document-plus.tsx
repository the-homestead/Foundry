...
interface DocumentPlusIconProps extends HTMLAttributes<HTMLDivElement> {
    size?: number;
}
...
const DocumentPlusIcon = forwardRef<DocumentPlusIconHandle, DocumentPlusIconProps>(({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    return (
        <div className={cn(className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props}>
            ...
            >
                ...
                <motion.path animate={controls} d="M12 11.25v6" initial="normal" variants={VERTICAL_LINE_VARIANT} />
                <motion.path animate={controls} d="M9 14.25H15" initial="normal" variants={HORIZONTAL_LINE_VARIANT} />
            </svg>
        </div>
    );
});
