...
const ExclamationTriangleIcon = forwardRef<ExclamationTriangleIconHandle, ExclamationTriangleIconProps>(({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
