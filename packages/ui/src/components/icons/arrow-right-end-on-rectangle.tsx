...
interface ArrowRightEndOnRectangleIconProps extends HTMLAttributes<HTMLDivElement> {
    size?: number;
}
...
const ArrowRightEndOnRectangleIcon = forwardRef<ArrowRightEndOnRectangleIconHandle, ArrowRightEndOnRectangleIconProps>(
