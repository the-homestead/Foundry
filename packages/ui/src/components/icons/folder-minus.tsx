...
const FolderMinusIcon = forwardRef<FolderMinusIconHandle, FolderMinusIconProps>(({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
    ...
    return (
        <div className={cn(className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props}>
            ...
            >
                ...
                <motion.path animate={controls} d="M15 13.5H9" initial="normal" variants={SYMBOL_VARIANT} />
            </svg>
        </div>
    );
});
