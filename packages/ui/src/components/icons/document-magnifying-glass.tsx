...
interface DocumentMagnifyingGlassIconProps extends HTMLAttributes<HTMLDivElement> {
    size?: number;
}
...
const DocumentMagnifyingGlassIcon = forwardRef<DocumentMagnifyingGlassIconHandle, DocumentMagnifyingGlassIconProps>(
