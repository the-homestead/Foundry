...
const CurrencyBangladeshiIcon = forwardRef<CurrencyBangladeshiIconHandle, CurrencyBangladeshiIconProps>(({ onMouseEnter, onMouseLeave, className, size = 20, ...props }, ref) => {
