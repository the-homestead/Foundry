...
interface DocumentCurrencyPoundIconProps extends HTMLAttributes<HTMLDivElement> {
    size?: number;
}
...
const DocumentCurrencyPoundIcon = forwardRef<DocumentCurrencyPoundIconHandle, DocumentCurrencyPoundIconProps>(
