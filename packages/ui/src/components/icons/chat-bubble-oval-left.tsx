...
const ChatBubbleOvalLeftIcon = forwardRef<ChatBubbleOvalLeftIconHandle, ChatBubbleOvalLeftIconProps>(({ onMouseEnter, onMouseLeave, className, size = 20, ...props }, ref) => {
