...
interface MagnifyingGlassPlusIconProps extends HTMLAttributes<HTMLDivElement> {
    size?: number;
}
    ...
    return (
        <div className={cn(className)} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} {...props}>
            ...
            >
                ...
                <motion.path animate={controls} d="M10.5 7.5v6" initial="normal" variants={VERTICAL_LINE_VARIANT} />
                <motion.path animate={controls} d="M7.5 10.5h6" initial="normal" variants={HORIZONTAL_LINE_VARIANT} />
            </svg>
        </div>
    );
});
