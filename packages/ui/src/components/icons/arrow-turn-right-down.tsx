...
const ArrowTurnRightDownIcon = forwardRef<ArrowTurnRightDownIconHandle, ArrowTurnRightDownIconProps>(({ onMouseEnter, onMouseLeave, className, size = 28, ...props }, ref) => {
